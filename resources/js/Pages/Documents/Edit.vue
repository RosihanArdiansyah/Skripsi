    ...
    <div class="bg-white rounded-md shadow overflow-hidden max-w-3xl">
      <form @submit.prevent="update">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          ...
          <file-input v-model="form.cover" :error="form.errors.cover" class="pr-6 pb-8 w-full lg:w-1/2" type="file" accept="image/*" label="Photo" />
          <file-input v-model="form.files" :error="form.errors.files" class="pr-6 pb-8 w-full lg:w-1/2" type="file" accept=".jpg" label="Photo" />
        </div>
