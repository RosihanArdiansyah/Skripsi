  ...
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('docs')">
        <icon name="book" class="w-4 h-4 mr-2" :class="isUrl('docs') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('docs') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Documents</div>
      </inertia-link>
    </div>
    <div class="mb-4">
